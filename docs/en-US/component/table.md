...
:::demo Table now shows vertical borders by default, which enables dragging column borders; set attribute `border` to `false` if you want to remove it.
...
Keep user-resized column widths after refreshing the page.

:::demo Set a unique `id` on the table to enable automatic persistence (the key format is `tableView:${location.origin}:${route.path}#${tableId}`), keep column identifiers stable, and use `save-column-width` if you ever need to opt out.

table/persist-column-width
...
| id                                 | native `id` attribute applied to the table root. Required to enable persisted column widths                                                                                                                                                                                | ^[string]                                                                                                                                                            | —                                                                                                                       |
...
| save-column-width                  | automatically persist user resized column widths (requires `id`)                                                                                                                                                                                                           | ^[boolean]                                                                                                                                                           | true                                                                                                                    |
